  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          helpText: "Names and details of the inventors",
          placeholder: "List all inventors with their titles and departments",
          order: 5,
          isRequired: true,
        },
        {
          ...
          label: "Department(s)",
          type: FieldType.LONG_TEXT,
          helpText: "Departments involved in this technology",
